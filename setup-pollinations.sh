...
# All 23 non-hidden, non-specialized text models available as alternatives
NEW_CONFIG=$(cat <<EOF
{
  ...
  "agents": {
    "defaults": {
      ...
      "models": {
        ...
        "pollinations/nomnom": { "alias": "NomNom (Pollinations)" },
        "pollinations/polly": { "alias": "Polly (Pollinations)" }
      }
    }
  },
  "models": {
    ...
    "providers": {
      "pollinations": {
        ...
        "models": [
          ...
          {
            "id": "openai",
            "name": "GPT-5 Mini — Fast & balanced, vision support",
            "reasoning": false,
            "input": ["text", "image"],
            "cost": { "input": 0, "output": 0, "cacheRead": 0, "cacheWrite": 0 },
            "contextLength": 128000
          ...
          {
            "id": "openai-fast",
            "name": "GPT-5 Nano — Ultra fast & affordable",
            "reasoning": false,
            "input": ["text"],
            "cost": { "input": 0, "output": 0, "cacheRead": 0, "cacheWrite": 0 },
            "contextLength": 128000
          ...
          {
            "id": "openai-audio",
            "name": "GPT-4o Audio — Voice input & output",
            "reasoning": false,
            "input": ["text", "audio"],
            "cost": { "input": 0, "output": 0, "cacheRead": 0, "cacheWrite": 0 },
            "contextLength": 128000
          ...
          {
            "id": "gemini-fast",
            "name": "Gemini Flash Lite — Ultra fast, vision, search",
            "reasoning": false,
            "input": ["text", "image"],
            "cost": { "input": 0, "output": 0, "cacheRead": 0, "cacheWrite": 0 },
            "contextLength": 128000
          ...
          {
            "id": "qwen-coder",
            "name": "Qwen3 Coder — Specialized for code generation",
            "reasoning": false,
            "input": ["text"],
            "cost": { "input": 0, "output": 0, "cacheRead": 0, "cacheWrite": 0 },
            "contextLength": 128000
          ...
          {
            "id": "minimax",
            "name": "MiniMax M2.1 — Multi-language & agent workflows (200K)",
            "reasoning": true,
            "input": ["text"],
            "cost": { "input": 0, "output": 0, "cacheRead": 0, "cacheWrite": 0 },
            "contextLength": 200000
          ...
          {
            "id": "nova-fast",
            "name": "Nova Micro — Ultra fast & ultra cheap",
            "reasoning": false,
            "input": ["text"],
            "cost": { "input": 0, "output": 0, "cacheRead": 0, "cacheWrite": 0 },
            "contextLength": 128000
          ...
          {
            "id": "perplexity-fast",
            "name": "Perplexity Sonar — Fast web search with citations",
            "reasoning": false,
            "input": ["text"],
            "cost": { "input": 0, "output": 0, "cacheRead": 0, "cacheWrite": 0 },
            "contextLength": 128000
          },
          {
            ...
            "name": "Perplexity Reasoning — Advanced reasoning + web search",
            "reasoning": true,
            "input": ["text"],
            "cost": { "input": 0, "output": 0, "cacheRead": 0, "cacheWrite": 0 },
            "contextLength": 128000
          ...
          {
            "id": "polly",
            "name": "Polly — Pollinations AI assistant with code search & web",
            "reasoning": true,
            "input": ["text"],
            "cost": { "input": 0, "output": 0, "cacheRead": 0, "cacheWrite": 0 },
            "contextLength": 128000
          ...
          {
            "id": "openai-large",
            "name": "GPT-5.2 — Most powerful & intelligent (Paid)",
            "reasoning": true,
            "input": ["text", "image"],
            "cost": { "input": 0, "output": 0, "cacheRead": 0, "cacheWrite": 0 },
            "contextLength": 128000
          ...
          {
            "id": "claude-large",
            "name": "Claude Opus 4.6 — Most intelligent model (Paid)",
            "reasoning": false,
            "input": ["text", "image"],
            "cost": { "input": 0, "output": 0, "cacheRead": 0, "cacheWrite": 0 },
            "contextLength": 200000
          ...
          {
            "id": "gemini-large",
            "name": "Gemini 3 Pro — 1M context, vision, audio & video (Paid)",
            "reasoning": true,
            "input": ["text", "image"],
            "cost": { "input": 0, "output": 0, "cacheRead": 0, "cacheWrite": 0 },
...
echo "  Web search:    Perplexity Sonar via web_search tool"
echo "  Free models:   17 available (kimi, deepseek, glm, openai, openai-fast, openai-audio,"
echo "                 gemini-fast, gemini-search, claude-fast, mistral, qwen-coder,"
echo "                 minimax, nova-fast, perplexity-fast, perplexity-reasoning, nomnom, polly)"
echo "  Paid models:   6 available (openai-large, claude, claude-large, gemini, gemini-large, grok)"
echo ""
